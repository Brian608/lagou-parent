...
// 开启端⼝/oauth/check_token的访问权限（允许）
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws
        ...
        clients.inMemory()// 客户端信息存储在什么地⽅，可以在内存中，可以在数据库⾥
                ...
                .resourceIds("autodeliver") // 指定客户端所能访问资源 id清单，此处的资源id是需要在具体的资源服务器上也配置⼀样
...
// 客户端的权限范围，此处配置为all全部即可
    ...
    public void configure(AuthorizationServerEndpointsConfigurer
        ...
        endpoints
                ...
                .authenticationManager(authenticationManager) // 指定认证管 理器，随后注⼊⼀个到当前类使⽤即可
